"""
scrapers/microsoft_careers.py — Real job scraper for Microsoft Careers.
"""

from __future__ import annotations
from typing import Any
from scrapers.base_scraper import BaseScraper
from scrapers.live_sources import collect_microsoft_india
from scrapers.models import JobOpportunity


class MicrosoftCareersScraper(BaseScraper):
    source_name: str = "Microsoft Careers"
    base_url: str = "https://jobs.careers.microsoft.com"
    ...
    def scrape(self, keyword: str, location: str, html: str | None = None, **kwargs: Any) -> list[JobOpportunity]:
        ...
        return collect_microsoft_india(keyword, location, limit=kwargs.get("limit", 10), html=html)
